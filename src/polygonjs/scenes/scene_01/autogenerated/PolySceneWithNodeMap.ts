...
export class PolySceneWithNodeMap_scene_01 extends PolyScene {
	...
	node(path: '/orthographicCamera1/eventsNetwork1/cameraOrbitControls1'): CameraOrbitControlsEventNode;
	...
	node(path: '/cubes/actor1/triggerTwoWaySwitch1'): TriggerTwoWaySwitchActorNode;
...
export interface PolySceneProps_scene_01 {
	...
	'cubes-actor1-clamp1--value0'?: ParamValueSerializedTypeMap['float'];
